    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CartRecycleView.this, Category.class);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CartRecycleView.this, CartRecycleView.class);
                intent.putExtra("userName",phn);
                startActivity(intent);
            }
        });
        ...
        wishlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CartRecycleView.this, WishlistRecycleView.class);
                intent.putExtra("userName",phn);
                startActivity(intent);
            }
        });
